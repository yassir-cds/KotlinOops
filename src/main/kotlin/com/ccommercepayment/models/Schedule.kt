...

{
    ...
    */
    ...
    enum class State(val value: kotlin.String){
        ...
        @Json(name = "inPayment") inPayment("inPayment"),
        @Json(name = "payed") payed("payed"),
        @Json(name = "confirmed") confirmed("confirmed"),
        @Json(name = "refused") refused("refused"),
        @Json(name = "cancelled") cancelled("cancelled"),
        @Json(name = "pending") pending("pending"),
        @Json(name = "undetermined") undetermined("undetermined"),
        @Json(name = "discarded") discarded("discarded"),
        @Json(name = "cashing") cashing("cashing"),
        @Json(name = "cashed") cashed("cashed");
    }
}
