...

{
    ...
    */
    ...
    enum class PaymentResultCodeMessage(val value: kotlin.String){
        ...
        @Json(name = "notProcessed") notProcessed("notProcessed");
    }
    /**
    * The complementary response code message of the service
    ...
    */
    ...
    enum class PaymentResultComplementaryCodeMessage(val value: kotlin.String){
        ...
        @Json(name = "paymentInformationFillingAttemptLimitExceeded") paymentInformationFillingAttemptLimitExceeded("paymentInformationFillingAttemptLimitExceeded"),
