...

{
    ...
    */
    ...
    enum class CardScheme(val value: kotlin.String){
        ...
        @Json(name = "cdiscount") cdiscount("cdiscount"),
        @Json(name = "casino") casino("casino"),
        @Json(name = "cofinoga") cofinoga("cofinoga"),
        @Json(name = "amex") amex("amex"),
        @Json(name = "finaref") finaref("finaref"),
        @Json(name = "aurore") aurore("aurore"),
        @Json(name = "cdiscount_Cup") cdiscountCup("cdiscount_Cup"),
        @Json(name = "diners") diners("diners"),
        @Json(name = "exito") exito("exito"),
        @Json(name = "exitoFranquicia") exitoFranquicia("exitoFranquicia"),
        @Json(name = "payPal") payPal("payPal"),
        @Json(name = "banContact") banContact("banContact"),
        @Json(name = "pse") pse("pse"),
        @Json(name = "paylib") paylib("paylib");
    }
}
